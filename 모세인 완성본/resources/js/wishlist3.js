...
document.getElementById('heart_good').addEventListener('click', function() {
    var url = `https://rarely-current-dane.ngrok-free.app/wlist/save?user_id=${user_id}&item_id=3`;
    ...
    fetch(url, {
        ...
        .then(function(response) {
            ...
            localStorage.setItem('heartStatus3', '1');
        })
...
document.getElementById('heart_bad').addEventListener('click', function() {
    var url = `https://rarely-current-dane.ngrok-free.app/wlist/delete?user_id=${user_id}&item_id=3`;
...
document.getElementById('cart').addEventListener('click', function() {
    var url = `https://rarely-current-dane.ngrok-free.app/order/save?user_id=${user_id}&item_id=3`;
